# ---------------------------- CONFIGURATION ----------------------------
$sourceTenantId = "cd7bd4e0-1364-439d-8dc4-bc0ef1fb2bf5"
$targetTenantId = "cd7bd4e0-1364-439d-8dc4-bc0ef1fb2bf5"
...
Connect-AzAccount -TenantId $sourceTenantId -SubscriptionId $sourceSubscriptionId
...
Connect-AzAccount -TenantId $targetTenantId -SubscriptionId $targetSubscriptionId
