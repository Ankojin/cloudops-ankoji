...
$groups = Import-Csv "C:\Ankoji\scripts\babaddgroups.csv" | Where-Object { $_.GroupName -and $_.GroupName.Trim() -ne "" }
$users  = Import-Csv "C:\Ankoji\scripts\babgroupsusers.csv"
