...
function Test-UDPConnectivity {
    ...
    Write-Status "Testing UDP connectivity to $Target port $Port..."
...
if ($RealTime) {
    ...
    Write-Status "UDP Port $Port Accessible: $portCheck"
    ...
    Write-Status "4. Run: .\Monitor-S2S-RDP.ps1 -RealTime"
}
