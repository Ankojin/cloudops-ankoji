...
<li>CSV reports: <b><a href="csv/chargeback_by_namespace.csv">chargeback_by_namespace.csv</a></b> &nbsp;|&nbsp; <b><a href="csv/pvc_inventory.csv">pvc_inventory.csv</a></b> &nbsp;|&nbsp; <b><a href="csv/top_pvc_consumers.csv">top_pvc_consumers.csv</a></b> &nbsp;|&nbsp; <a href="csv/">csv/</a></li>
