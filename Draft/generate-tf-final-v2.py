...
csv_file_path = "./migration-vms-list-key.csv"
output_tf_file = "./main-v2.tf"
cloud_init_file = "./cloud-init.yaml"  # Path to cloud-init file
...
resource "azurerm_virtual_machine_extension" "DependencyAgentLinux__{vm_name}" {{
...
""")
    ...
    print("Terraform configuration has been generated in main-v2.tf")
