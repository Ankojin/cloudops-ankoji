...
csv_file_path = "./VM-Creation/migration-vms-list_ebs.csv"
output_tf_file = "./VM-Creation/main-v1.tf"
cloud_init_file = "./VM-Creation/cloud-init.yaml"  # Path to cloud-init file
